# Generated by Powerlevel10k configuration wizard on 2019-10-29 at 14:08 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 51841.
# Wizard options: awesome-patched + powerline, small icons, lean, time, 2 lines,
...
() {
  ...
  # For now, disable the warning. Seems to be an error in p10k itself.
