# Generated by Powerlevel10k configuration wizard on 2019-09-08 at 12:55 EDT.
...
() {
  ...
  vcs+='${${${$(($#VCS_STATUS_LOCAL_BRANCH<=48)):#0}:+${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  # If local branch name is over 48 characters long, show the first 12 … the last 12. The same as
  ...
  # Separate environment name from Python version with ()
